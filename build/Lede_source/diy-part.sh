...
cat >$NETIP <<-EOF
uci set network.lan.ipaddr='192.168.4.76'                      # IPv4 地址(openwrt后台地址)
uci set network.lan.netmask='255.255.255.0'                   # IPv4 子网掩码
uci set network.lan.gateway='192.168.4.110'                     # IPv4 网关
uci set network.lan.broadcast='192.168.4.255'                 # IPv4 广播
